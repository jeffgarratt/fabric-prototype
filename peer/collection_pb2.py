...
from peer import policy_pb2 as peer_dot_policy__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='peer/collection.proto',
  package='protos',
  syntax='proto3',
  ...
  ,
  dependencies=[common_dot_policies__pb2.DESCRIPTOR,peer_dot_policy__pb2.DESCRIPTOR,])
...
_STATICCOLLECTIONCONFIG.fields_by_name['endorsement_policy'].message_type = peer_dot_policy__pb2._APPLICATIONPOLICY
...
CollectionConfigPackage = _reflection.GeneratedProtocolMessageType('CollectionConfigPackage', (_message.Message,), dict(
  ...
  __module__ = 'peer.collection_pb2'
