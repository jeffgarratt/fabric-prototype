...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[peer_dot_proposal__response__pb2.DESCRIPTOR,common_dot_common__pb2.DESCRIPTOR,])
...
_TXVALIDATIONCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_CHAINCODE', index=25, number=25,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NOT_VALIDATED', index=26, number=254,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_OTHER_REASON', index=27, number=255,
      options=None,
      type=None),
  ],
...
_METADATAKEYS = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VALIDATION_PARAMETER_V2', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
