...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='peer/signed_cc_dep_spec.proto',
  package='protos',
  syntax='proto3',
  ...
  ,
  dependencies=[peer_dot_proposal__response__pb2.DESCRIPTOR,])
...
_SIGNEDCHAINCODEDEPLOYMENTSPEC.fields_by_name['owner_endorsements'].message_type = peer_dot_proposal__response__pb2._ENDORSEMENT
...
SignedChaincodeDeploymentSpec = _reflection.GeneratedProtocolMessageType('SignedChaincodeDeploymentSpec', (_message.Message,), dict(
  ...
  __module__ = 'peer.signed_cc_dep_spec_pb2'
