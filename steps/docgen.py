...
class DocumentGenerator:
    ...
    def __init__(self, contextHelper):
        ...
        weave(target=self.contextHelper.get_bootstrap_helper, advices=self.getBootstrapHelperAdvice)
    ...
    def registerOrgAdvice(self, joinpoint):
        ...
        (fileName, fileExists) = self.contextHelper.getTmpPathForName(name="dir-org-{0}-privatekey".format(orgName), extension="pem")
        with open(fileName, 'w') as f:
            f.write(newlyRegisteredOrg.getPrivateKeyAsPEM())
