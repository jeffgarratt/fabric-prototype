...
_SUBMITREQUEST.fields_by_name['payload'].message_type = common_dot_common__pb2._ENVELOPE
_SUBMITRESPONSE.fields_by_name['status'].enum_type = common_dot_common__pb2._STATUS
...
StepRequest = _reflection.GeneratedProtocolMessageType('StepRequest', (_message.Message,), dict(
  ...
  __module__ = 'orderer.cluster_pb2'
