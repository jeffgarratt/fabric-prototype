...
_STATICCOLLECTIONCONFIG.fields_by_name['endorsement_policy'].message_type = common_dot_policies__pb2._APPLICATIONPOLICY
...
_COLLECTIONCONFIGPACKAGE.has_options = True
_COLLECTIONCONFIGPACKAGE._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
_COLLECTIONCONFIG.has_options = True
_COLLECTIONCONFIG._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
_STATICCOLLECTIONCONFIG.has_options = True
_STATICCOLLECTIONCONFIG._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
_COLLECTIONPOLICYCONFIG.has_options = True
_COLLECTIONPOLICYCONFIG._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
