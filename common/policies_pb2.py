...
_APPLICATIONPOLICY = _descriptor.Descriptor(
  ...
  full_name='common.ApplicationPolicy',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='signature_policy', full_name='common.ApplicationPolicy.signature_policy', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='channel_config_policy_reference', full_name='common.ApplicationPolicy.channel_config_policy_reference', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='Type', full_name='common.ApplicationPolicy.Type',
      index=0, containing_type=None, fields=[]),
  ],
...
_APPLICATIONPOLICY.fields_by_name['signature_policy'].message_type = _SIGNATUREPOLICYENVELOPE
...
_APPLICATIONPOLICY.has_options = True
_APPLICATIONPOLICY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\030\001'))
