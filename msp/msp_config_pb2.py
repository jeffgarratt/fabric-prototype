...
_FABRICNODEOUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='admin_ou_identifier', full_name='msp.FabricNodeOUs.admin_ou_identifier', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orderer_ou_identifier', full_name='msp.FabricNodeOUs.orderer_ou_identifier', index=4,
...
_FABRICNODEOUS.fields_by_name['admin_ou_identifier'].message_type = _FABRICOUIDENTIFIER
_FABRICNODEOUS.fields_by_name['orderer_ou_identifier'].message_type = _FABRICOUIDENTIFIER
